...
def fRegLinSimp(m,n):#promedio movil simple
    ...
    def fwzzExp():
        ...
        def fwz():
            ...
            Label(v1, text="Nivel de confianza", fg="black").place(x=10, y=200)
            Label(v1, text=al, fg="red").place(x=130, y=200)
            Label(v1, text="%", fg="black").place(x=160, y=200)
            Label(v1, text="Z-Acumulada:", fg="black").place(x=10, y=220)
            Label(v1, text=round(val,3), fg="red").place(x=105, y=220)
            Label(v1, text="Z-Estimado", fg="black").place(x=10, y=240)
            Label(v1, text=round(z,3), fg="red").place(x=105, y=240)
        ...
        Entry(v1,textvariable=v2,bg="black", fg="red").place(x=100,y=130)
    ...
    def fwzzExp1():
        ...
        def fwz1():                    
            ...
            a,b=modeloRLS(m,n)
            w=a*z
            Label(v1, text=round(z,3), fg="red").place(x=105, y=340)
            Label(v1, text=round(a,3), fg="red").place(x=105, y=360)
            Label(v1, text=round(w,3), fg="red").place(x=105, y=380)
            return z

        bsum=Button(v1,command=fwz1,text='Gauss::Z',padx=42,pady=5).place(x=100, y=280)
        return z    
