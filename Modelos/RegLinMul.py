...
def fRegLinMulti(m,n,data):#promedio movil simple
    ...
    def fRLM1(m,n):   
        ...
        for i in range(len(B)):
            if i==0:     
                v5.create_text(w-(200+(110*i)),h1+40,text=str((round(B[i][j],2))),fill='black',font=('verdena',10, 'bold'))
                v5.create_text(w-(170+(135*i)),h1+40,text="+",fill='orange2',font=('verdena',12, 'bold'))
                
                
            else:
                if  i==len(B)-1:
                    v5.create_text(w-(200-(80*i)),h1+40,text=str((round(B[i][j],2))),fill='black',font=('verdena', 10, 'bold'))
    ...
    def fCMEe2(m,n):     
        ...
        v1.create_text(w-260,h1+60,text="Y="+str(xTy),fill='orange2',font=('Verdana', 10, 'bold'))
