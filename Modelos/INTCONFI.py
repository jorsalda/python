...
z=0.0
bsum=0.0
def fInterConfi(m,n):#promedio movil simple
    root = Tk()
    ...
    def fwzzExp():
        def fwz():
            global z
            al=v2.get()
            val=(al/100.0)+(((1.0-(al/100.0))))/2
            z=norm.ppf(val)
            Label(v1, text="Nivel de confianza", fg="black").place(x=100, y=200)
            Label(v1, text=al, fg="red").place(x=220, y=200)
            Label(v1, text="%", fg="black").place(x=240, y=200)
            Label(v1, text="Z-Acumulada:", fg="black").place(x=100, y=220)
            Label(v1, text=round(val,3), fg="red").place(x=220, y=220)
            Label(v1, text="Z-Estimado", fg="black").place(x=100, y=240)
            Label(v1, text=round(z,3), fg="red").place(x=220, y=240)      
            return z
        
        v2=IntVar(v1,value=0)
        Label(v1, text="Ingrese nivel de confianza:", fg="black").place(x=100, y=130)
        Entry(v1,textvariable=v2,bg="black", fg="red",width=5).place(x=270,y=130)
        bsum=Button(v1,command=fwz,text='Gauss::Z',padx=42,pady=5).place(x=100, y=160)
    ...
    def fwzzExp1():       
        def fwz1():                    
            ...
            Label(v1, text=round(py,3), fg="black").place(x=350, y=200)
            Label(v1, text="[", fg="black").place(x=315, y=230)
            Label(v1, text=round(intif,2), fg="blue").place(x=325, y=230)
            Label(v1, text=",", fg="black").place(x=380, y=230)
            Label(v1, text=round(intsu,2), fg="red").place(x=395, y=230)
            Label(v1, text="]", fg="black").place(x=437, y=230)
            return z

        bsum=Button(v1,command=fwz1,text='Inter-Conf',padx=42,pady=5).place(x=300, y=160)
        return z    
        
    def fIntConfi(m,n):      
        py,svy,svy,svyc=fprom(m,n)   
        v1.create_text(w-30,h1-200,text="Intervalo de Confianza para la estimacion puntual",fill='black',font=('verdena', 10, 'bold'))
        v1.create_line((w-220,h1-190),(w+100,h1-190))
        v1.create_text(w-260,h1-160,text="n=",fill='orange2',font=('Verdana', 10, 'bold'))
        v1.create_text(w-230,h1-160,text=str(round(n)),fill='black',font=('Verdana', 8, 'normal'))
        v1.create_text(w-160,h1-160,text="SumX=",fill='orange2',font=('Verdana', 10, 'bold'))
        v1.create_text(w-95,h1-160,text=str(round(svy,2)),fill='black',font=('Verdana', 8, 'normal'))
        v1.create_text(w,h1-160,text="SumXCua=",fill='orange2',font=('Verdana', 10, 'bold'))
        v1.create_text(w+70,h1-160,text=str(round(svyc,2)),fill='black',font=('Verdana', 8, 'normal'))
        v1.create_text(w+160,h1-160,text="Promedio=",fill='orange2',font=('Verdana', 10, 'bold'))
        v1.create_text(w+225,h1-160,text=str(round(py,2)),fill='black',font=('Verdana', 8, 'normal'))
    ...
    def fgrafica():
        ...
        bsum=Button(v1,command=grafica,text='Grafica',padx=42,pady=5).place(x=100, y=380)
