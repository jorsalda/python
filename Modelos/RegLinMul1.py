...
def fRegLinMulti(m,n,data):#promedio movil simple
    ...
    def fAnov(m,n):
        SCT,SCR,SCE,MSE,S2,Fc= fAnova(m,n)
        ...
        v3.create_text(w-150,h1-160,text=round(SCR,2),fill='black',font=('courier',8, 'bold'))
        v3.create_text(w-145,h1-135,text=round(SCE,2),fill='black',font=('courier',8, 'bold'))
        v3.create_text(w-150,h1-105,text=round(SCT,2),fill='black',font=('courier',8, 'bold'))
        ...
        v3.create_text(w-60,h1-160,text=round(SCR,2),fill='black',font=('courier',8, 'bold'))
        v3.create_text(w-55,h1-135,text=round(S2,2),fill='black',font=('courier',8, 'bold'))
        v3.create_text(w-55,h1-105,text=round((SCT/(n-1)),2),fill='black',font=('courier',8, 'bold'))
    ...
    def fCalculos(m,n):
        x,xT,xTx,xTxInv,xyT,IxTxxyT,xIxTxxyT,prom=fRlm(m,n,data)
        v6.create_text(w-270,h1-220,text="Datos Iniciales",fill='purple',font=('courier',12, 'bold')) 
        v6.create_text(w-300,h1-140,text=transpose(m),fill='black',font=('courier',8, 'bold')) 
        v6.create_text(w-80,h1-220,text=" X ",fill='purple',font=('courier',12, 'bold')) 
        v6.create_text(w+120,h1-220,text="X-transpuesta",fill='purple',font=('courier',12, 'bold')) 
        v6.create_text(w-100,h1-140,text=x,fill='black',font=('courier',8, 'bold')) 
        v6.create_text(w+190,h1-140,text=xT,fill='black',font=('courier',8, 'bold'))
        
        v6.create_text(w-260,h1-60,text="'X' por  x-transpuesta",fill='purple',font=('courier',12, 'bold')) 
        v6.create_text(w+100,h1-60,text="Inv de X por X-trans",fill='purple',font=('courier',12, 'bold'))
        v6.create_text(w-260,h1-10,text=xTx,fill='black',font=('courier',8, 'bold')) 
        v6.create_text(w+210,h1-10,text=xTxInv,fill='black',font=('courier',8, 'bold'))
    ...
    def fRLM1(m,n):   
        ...
        v5.create_text(w-255,h1+40,text="Y=",fill='black',font=('verdena', 12, 'bold'))
        
          
        for i in range(len(xIxTxxyT)):
            if i==0:     
                v5.create_text(w-(200+(110*i)),h1+40,text=str((round(xIxTxxyT[i][j],2))),fill='black',font=('verdena',10, 'bold'))
                v5.create_text(w-(170+(135*i)),h1+40,text="+",fill='orange2',font=('verdena',12, 'bold'))
                
                
            else:
                if  i==len(xIxTxxyT)-1:
                    v5.create_text(w-(200-(80*i)),h1+40,text=str((round(xIxTxxyT[i][j],2))),fill='black',font=('verdena', 10, 'bold'))
                    v5.create_text(w-(200-(105*i)),h1+40,text="X ",fill='orange2',font=('verdena', 12, 'bold'))
                    #print  xTy[i][k],"X"
                else:
                    v5.create_text(w-(200-(80*i)),h1+40,text=str((round(xIxTxxyT[i][j],2))),fill='black',font=('verdena',10, 'bold'))
                    v5.create_text(w-(170-(80*i)),h1+40,text="X +",fill='orange2',font=('verdena',12, 'bold'))
                    #print  xTy[i][k],"X +",
    ...
    def fCMEe2(m,n):     
        ...
        v1.create_text(w-255,h1+40,text="Modelo Lineal Multiple",fill='black',font=('verdena', 10, 'bold'))
    ...
    v6 = Canvas(p6)# bg='gray30'
    w = v6.winfo_reqwidth()
    h = v6.winfo_reqheight()
    fCalculos(m,n)
    v6.pack(fill=BOTH, expand=1) 
